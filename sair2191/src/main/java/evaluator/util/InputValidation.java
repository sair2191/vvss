...
public class InputValidation {
	...
	public static void validateAnswer1(String varianta1) throws InputValidationFailedException{
	...
	public static void validateAnswer2(String varianta2) throws InputValidationFailedException{
	...
	public static void validateAnswer3(String varianta3) throws InputValidationFailedException{
	...
	public static void validateGoodAnswer(String variantaCorecta) throws InputValidationFailedException{
	...
	public static void validateDomain(String domeniu) throws InputValidationFailedException{
